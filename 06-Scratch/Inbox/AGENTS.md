...
3. Read `SYSTEMS.md` — operating rules and how to work with David
4. Read `memory/YYYY-MM-DD.md` (today + yesterday) for recent context
5. **If in MAIN SESSION** (direct chat with your human): Also read `MEMORY.md`
6. Check `clawchief/tasks.md` for active tasks
...
**⚓ Lead Admin Mode:** You're the lead admin instance. Own the setup. Be systematic. Document everything. Always be improving.
...
Workflows from `/Users/davidschy/.openclaw/workspace/clawflows/`. When the user asks you to do something that matches an enabled workflow, read its WORKFLOW.md and follow the steps.
...
### Creating Workflows
When the user wants to create a workflow, **read `/Users/davidschy/.openclaw/workspace/clawflows/docs/creating-workflows.md` first and follow it.** It walks you through the interactive flow — asking questions, then creating with `clawflows create --from-json`.
...
### Workflow Locations
- **Community workflows:** `/Users/davidschy/.openclaw/workspace/clawflows/workflows/available/community/`
- **Custom workflows:** `/Users/davidschy/.openclaw/workspace/clawflows/workflows/available/custom/`
- **Enabled workflows:** `/Users/davidschy/.openclaw/workspace/clawflows/workflows/enabled/` (symlinks)
...
- **check-calendar** (8am, 6pm): Calendar review — scans the next 48 hours for events, detects conflicts, calculates travel time, and generates prep notes for each meeting. → `/Users/davidschy/.openclaw/workspace/clawflows/workflows/enabled/check-calendar//WORKFLOW.md`
- **check-follow-ups** (9am, 4pm): Follow-up checker — scans for unanswered emails, promises you made, and things about to slip through the cracks. → `/Users/davidschy/.openclaw/workspace/clawflows/workflows/enabled/check-follow-ups//WORKFLOW.md`
- **check-repos** (on-demand): Git repo health check — scans local repos for uncommitted changes, stale branches, and unpushed commits. → `/Users/davidschy/.openclaw/workspace/clawflows/workflows/enabled/check-repos//WORKFLOW.md`
- **check-rsvps** (monday 9am, friday 9am): Finds event invitations in your email that still need a response → `/Users/davidschy/.openclaw/workspace/clawflows/workflows/enabled/check-rsvps//WORKFLOW.md`
- **send-expense-report** (on-demand): Expense report generator — scans email for receipts, categorizes spending, and sends a monthly summary. → `/Users/davidschy/.openclaw/workspace/clawflows/workflows/enabled/send-expense-report//WORKFLOW.md`
- **send-morning-briefing** (7am): Daily morning briefing — gathers weather, calendar, priorities, and urgent items, then delivers a comprehensive summary to start your day. → `/Users/davidschy/.openclaw/workspace/clawflows/workflows/enabled/send-morning-briefing//WORKFLOW.md`
- **triage-tasks** (8am): Daily task triage — reviews your task list, identifies what's due and overdue, and suggests your top 3 priorities for the day. → `/Users/davidschy/.openclaw/workspace/clawflows/workflows/enabled/triage-tasks//WORKFLOW.md`
- **update-clawflows** (1am): Pull the latest ClawFlows workflows and notify user of any announcements → `/Users/davidschy/.openclaw/workspace/clawflows/workflows/enabled/update-clawflows//WORKFLOW.md`
- **update-openclaw** (3am): Daily self-update of OpenClaw — pull latest version and restart. → `/Users/davidschy/.openclaw/workspace/clawflows/workflows/enabled/update-openclaw//WORKFLOW.md`
<!-- clawflows:end -->
